...
#if defined(NDEBUG)
# error "Cryptrox cannot be compiled without assertions."
#endif
...
// Dash
// CRYPTROX TODO: previously defined in net_processing.h, Bitcoin Core removed from .h but needed for Dash
        ...
        // CRYPTROX END
        {
          ...
          if (inv.type == MSG_TX || inv.type == MSG_WITNESS_TX) {
            ...
            // Dash
            {
                ...
                // CRYPTROX TODO: check if there are MSG_TX messages in Dash processing before removing this code
                /*
...
bool static ProcessMessage(CNode* pfrom, const std::string& strCommand, CDataStream& vRecv, int64_t nTimeReceived, const CChainParams& chainparams, CConnman* connman, const std::atomic<bool>& interruptMsgProc, bool enable_bip61)
{
    ...
    else if (strCommand == NetMsgType::TX)
    {
        ...
        // CRYPTROX TODO: // remove after implementation
        CTxLockRequest txLockRequest;
        CDarksendBroadcastTx dstx;
        /* CRYPTROX TODO: !!!!!!!!
        // CRYPTROX TODO: Dash txs
