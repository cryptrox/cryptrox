...
bool CPrivateSendClient::SendDenominate(const std::vector<CTxDSIn>& vecTxDSIn, const std::vector<CTxOut>& vecTxOut, CConnman& connman)
{
    ...
    //check it against the memory pool to make sure it's valid
    {
        ...
        // CRYPTROX TODO: if(!lockMain || !AcceptToMemoryPool(mempool, validationState, CTransaction(tx), false, NULL, false, true, true)) {
...
bool CPrivateSendClient::CheckAutomaticBackup()
{
    ...
    if(pwallet->nKeysLeftSinceAutoBackup < PRIVATESEND_KEYS_THRESHOLD_STOP) {
        ...
        if(fCreateAutoBackups) {
            ...
            // CRYPTROX TODO: enable after autobackupwallet implemented
