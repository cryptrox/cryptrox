...
//
{
    ...
    // CRYPTROX TODO: revise implementation of coinLowestLarger
    // Dash
    ...
    CAmount nTotal = 0;
    {
        ...
        for (map<uint256, CWalletTx>::const_iterator it = mapWallet.begin(); it != mapWallet.end(); ++it)
        {
            ...
            if (pcoin->IsTrusted()){
                ...
                for (unsigned int i = 0; i < pcoin->tx->vout.size(); i++) {
                    COutput out = COutput(pcoin, i, nDepth, true, true, true); // CRYPTROX TODO: last bool is fSafe
                    COutPoint outpoint = COutPoint(out.tx->GetHash(), out.i);
...
bool CWallet::CreateCollateralTransaction(CMutableTransaction& txCollateral, std::string& strReason)
{
    ...
    // CRYPTROX TODO: not sur if right way
        ...
        LOCK2(cs_main, cs_wallet);
        {
            ...
            while (true)
            {
                ...
                if (nChange > 0)
                {
                    ...
                    // CRYPTROX TODO: aligned to left because of original Bitcoin Core code compatibility
                    // Fill a vout to ourself
                    ...
                    // CRYPTROX TODO: end of compatibility alignement
                    }
                } else {
                    nChangePosInOut = -1;
                }
...
/* CRYPTROX TODO: something wrong here
                // Dash
