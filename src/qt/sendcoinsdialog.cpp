...
void SendCoinsDialog::on_sendButton_clicked()
{
    ...
    // Dash
    // CRYPTROX TODO: privatesend and instantsend checkbox must be added to GUI! next two rows are just temporary placeholder!
    ...
    // CRYPTROX TODO: Obsolete check, remove later
...
void SendCoinsDialog::coinControlChangeEdited(const QString& text)
{
    if (model && model->getAddressTableModel())
    {
        ...
        {
            ui->labelCoinControlChangeLabel->setText(tr("Warning: Invalid Cryptroxcoin address"));
        }
        else // Valid address
        {
