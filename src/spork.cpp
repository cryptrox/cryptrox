...
void CSporkManager::LoadSporksFromDB()
{
    ...
    for (int i = SPORK_START; i <= SPORK_CRYPTROX_END; ++i) {
        if (i > SPORK_END && i < SPORK_CRYPTROX_START) i = SPORK_CRYPTROX_START;
    // CRYPTROX END
...
bool CSporkManager::IsSporkActive(int nSporkID)
{
    ...
    if(mapSporksActive.count(nSporkID)){
        ...
        switch (nSporkID) {
            ...
            // CRYPTROX BEGIN
            case SPORK_CRYPTROX_01_HANDBRAKE_HEIGHT :           r = SPORK_CRYPTROX_01_HANDBRAKE_HEIGHT_DEFAULT; break;
            case SPORK_CRYPTROX_01_HANDBRAKE_FORCE_X16R:        r = SPORK_CRYPTROX_01_HANDBRAKE_FORCE_X16R_DEFAULT; break;

            case SPORK_CRYPTROX_02_IGNORE_SLIGHTLY_HIGHER_COINBASE:     r = SPORK_CRYPTROX_02_IGNORE_SLIGHTLY_HIGHER_COINBASE_DEFAULT; break;
            case SPORK_CRYPTROX_02_IGNORE_FOUNDER_REWARD_CHECK:         r = SPORK_CRYPTROX_02_IGNORE_FOUNDER_REWARD_CHECK_DEFAULT; break;
            case SPORK_CRYPTROX_02_IGNORE_FOUNDER_REWARD_VALUE:         r = SPORK_CRYPTROX_02_IGNORE_FOUNDER_REWARD_VALUE_DEFAULT; break;
            case SPORK_CRYPTROX_02_IGNORE_MASTERNODE_REWARD_VALUE:      r = SPORK_CRYPTROX_02_IGNORE_MASTERNODE_REWARD_VALUE_DEFAULT; break;
            case SPORK_CRYPTROX_02_IGNORE_MASTERNODE_REWARD_PAYEE:      r = SPORK_CRYPTROX_02_IGNORE_MASTERNODE_REWARD_PAYEE_DEFAULT; break;

            case SPORK_CRYPTROX_03_BLOCK_REWARD_SMOOTH_HALVING_START:   r = SPORK_CRYPTROX_03_BLOCK_REWARD_SMOOTH_HALVING_START_DEFAULT; break;
            // CRYPTROX END
            default:
...
int64_t CSporkManager::GetSporkValue(int nSporkID)
{
    ...
    switch (nSporkID) {
        ...
        // CRYPTROX BEGIN
        case SPORK_CRYPTROX_01_HANDBRAKE_HEIGHT:            return SPORK_CRYPTROX_01_HANDBRAKE_HEIGHT_DEFAULT;
        case SPORK_CRYPTROX_01_HANDBRAKE_FORCE_X16R:        return SPORK_CRYPTROX_01_HANDBRAKE_FORCE_X16R_DEFAULT;

        case SPORK_CRYPTROX_02_IGNORE_SLIGHTLY_HIGHER_COINBASE:     return SPORK_CRYPTROX_02_IGNORE_SLIGHTLY_HIGHER_COINBASE_DEFAULT;
        case SPORK_CRYPTROX_02_IGNORE_FOUNDER_REWARD_CHECK:         return SPORK_CRYPTROX_02_IGNORE_FOUNDER_REWARD_CHECK_DEFAULT;
        case SPORK_CRYPTROX_02_IGNORE_FOUNDER_REWARD_VALUE:         return SPORK_CRYPTROX_02_IGNORE_FOUNDER_REWARD_VALUE_DEFAULT;
        case SPORK_CRYPTROX_02_IGNORE_MASTERNODE_REWARD_VALUE:      return SPORK_CRYPTROX_02_IGNORE_MASTERNODE_REWARD_VALUE_DEFAULT;
        case SPORK_CRYPTROX_02_IGNORE_MASTERNODE_REWARD_PAYEE:      return SPORK_CRYPTROX_02_IGNORE_MASTERNODE_REWARD_PAYEE_DEFAULT;

        case SPORK_CRYPTROX_03_BLOCK_REWARD_SMOOTH_HALVING_START:   return SPORK_CRYPTROX_03_BLOCK_REWARD_SMOOTH_HALVING_START_DEFAULT;
        // CRYPTROX END
        default:
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    // CRYPTROX BEGIN
    if (strName == "SPORK_CRYPTROX_01_HANDBRAKE_HEIGHT")            return SPORK_CRYPTROX_01_HANDBRAKE_HEIGHT;
    if (strName == "SPORK_CRYPTROX_01_HANDBRAKE_FORCE_X16R")        return SPORK_CRYPTROX_01_HANDBRAKE_FORCE_X16R;

    if (strName == "SPORK_CRYPTROX_02_IGNORE_SLIGHTLY_HIGHER_COINBASE")     return SPORK_CRYPTROX_02_IGNORE_SLIGHTLY_HIGHER_COINBASE;
    if (strName == "SPORK_CRYPTROX_02_IGNORE_FOUNDER_REWARD_CHECK")         return SPORK_CRYPTROX_02_IGNORE_FOUNDER_REWARD_CHECK;
    if (strName == "SPORK_CRYPTROX_02_IGNORE_FOUNDER_REWARD_VALUE")         return SPORK_CRYPTROX_02_IGNORE_FOUNDER_REWARD_VALUE;
    if (strName == "SPORK_CRYPTROX_02_IGNORE_MASTERNODE_REWARD_VALUE")      return SPORK_CRYPTROX_02_IGNORE_MASTERNODE_REWARD_VALUE;
    if (strName == "SPORK_CRYPTROX_02_IGNORE_MASTERNODE_REWARD_PAYEE")      return SPORK_CRYPTROX_02_IGNORE_MASTERNODE_REWARD_PAYEE;

    if (strName == "SPORK_CRYPTROX_03_BLOCK_REWARD_SMOOTH_HALVING_START")   return SPORK_CRYPTROX_03_BLOCK_REWARD_SMOOTH_HALVING_START;
    // CRYPTROX END
...
std::string CSporkManager::GetSporkNameByID(int nSporkID)
{
    switch (nSporkID) {
        ...
        // CRYPTROX BEGIN
        case SPORK_CRYPTROX_01_HANDBRAKE_HEIGHT:            return "SPORK_CRYPTROX_01_HANDBRAKE_HEIGHT";
        case SPORK_CRYPTROX_01_HANDBRAKE_FORCE_X16R:        return "SPORK_CRYPTROX_01_HANDBRAKE_FORCE_X16R";

        case SPORK_CRYPTROX_02_IGNORE_SLIGHTLY_HIGHER_COINBASE:     return "SPORK_CRYPTROX_02_IGNORE_SLIGHTLY_HIGHER_COINBASE";
        case SPORK_CRYPTROX_02_IGNORE_FOUNDER_REWARD_CHECK:         return "SPORK_CRYPTROX_02_IGNORE_FOUNDER_REWARD_CHECK";
        case SPORK_CRYPTROX_02_IGNORE_FOUNDER_REWARD_VALUE:         return "SPORK_CRYPTROX_02_IGNORE_FOUNDER_REWARD_VALUE";
        case SPORK_CRYPTROX_02_IGNORE_MASTERNODE_REWARD_VALUE:      return "SPORK_CRYPTROX_02_IGNORE_MASTERNODE_REWARD_VALUE";
        case SPORK_CRYPTROX_02_IGNORE_MASTERNODE_REWARD_PAYEE:      return "SPORK_CRYPTROX_02_IGNORE_MASTERNODE_REWARD_PAYEE";

        case SPORK_CRYPTROX_03_BLOCK_REWARD_SMOOTH_HALVING_START:   return "SPORK_CRYPTROX_03_BLOCK_REWARD_SMOOTH_HALVING_START";
        // CRYPTROX END
        default:
