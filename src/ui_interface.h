...
#ifndef CRYPTROX_UI_INTERFACE_H
#define CRYPTROX_UI_INTERFACE_H
...
public:
    ...
    // CRYPTROX TODO: boost::signals2::signal<void (int newNumMasternodes)> NotifyStrMasternodeCountChanged; 
    ...
    // CRYPTROX TODO: boost::signals2::signal<void (std::function<void(void)> action)> SetProgressBreakAction; 
